...
\begin{itemize}
    \item \textbf{CPU Architecture:} AMD Ryzen 7 5800H (Zen 3 architecture, highly optimized for cryptographic vector extensions)
    ...
    \item \textbf{Compiler Toolchain:} GNU C++ Compiler (g++) version 15.2.0 (Ubuntu) with standard optimization flags enabled.
\end{itemize}
